...
//螺丝丢失二次检测模型
//const trt_basic_config screw_loss = { "v5","x",0.1,0.5 ,320,320,"loss_screw_yolov5x_320_2_dongjie",{"001","002"} };{"screw_loss",screw_loss},
//面阵相机螺丝检测
...
//撒沙咀检测
//const trt_basic_config sashazui_config = { "v5","n",0.5,0.5 ,800,800,"nozzle_yolov5n_800",{"screw","rect","up","down"} };,{"sashazui",sashazui_config}
//易丢失部件检测
...
//车头检测
//const trt_basic_config ct_config = { "v5","m", 0.25 ,0.45,1024,1024,"AK_CLW_yolov560_m_1024_2_1208",{"AK","CLW"} };{"ct",ct_config},
//转向架部件检测
...
std::map<std::string, trt_basic_config> init_list_info = { { "screw",screw_config },{"screw_db",screw_config_db},{"screw_mz",screw_mz_config},{ "loss_check",losscheck_config } ,
	{ "locking_wire", locking_wire_config },{ "oil_level",oil_config } ,{ "foreign_body",foreign_body_config },{ "foreign_body1",foreign_body_config1 },{"oil_leakage",oil_leakage_config},{"zxj",zxj_part_config}};

//分类模型
const infer_class_config locking_wire_class = { 2,1,3,256,256,{ 0.485, 0.456,0.406 },{  0.229, 0.224,0.225 },"../model/TS_class_xception_2_256.onnx",{"TS_DL","TS_FS"}};
const infer_class_config dbbolts_class      = { 3,1,3,256,256,{ 0.485, 0.456,0.406 },{  0.229, 0.224,0.225 },"../model/screw_xception_3_256.onnx",{ "green_ls", "kls", "loose_ls"}};

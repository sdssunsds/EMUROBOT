...
namespace Basler
{
    public class BaslerCamera : ICamera
    {
        ...
        public void SetEvent(CameraError cameraError, CameraStateChanged cameraStateChanged, ImageReady imageReady)
        {
            this.CameraError = (object sender, CameraErrorEventArgs e) => { cameraError(sender, e); };
            this.CameraStatusChanged = (object sender, CameraStatusEventArgs e) => { cameraStateChanged(sender, e); };
            this.ImageReady = (object sender, CameraEventArgs e) => { imageReady(sender, e); };
        }
        #endregion
    }
}

...
namespace UploadImageServer.Model
{
    public class PuzzleCdoublePlus
    {
        ...
        [DllImport("yolov5_Trt.dll")]
        public static extern int Callcutimg(IntPtr obj, config_info input_info, [In, Out] inputrect_4[] cut_info, int cut_info_length, [In, Out] int[] length, int length_num, ref int progressIndex);
